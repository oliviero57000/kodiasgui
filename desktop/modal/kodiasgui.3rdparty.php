...
if (init('path') == '') {
	throw new Exception('{{Aucun chemin fourni}}');
}
$kodiasgui = kodiasgui::byPath(init('path'));
if (!is_object($kodiasgui)) {
	throw new Exception('{{Kodi non trouvé}}');
}
...
<span style="display: none;" class="md_fileMangeAttr" data-l1key="path"><?php echo $kodiasgui->getPath();?></span>
<input class="btn btn-warning pull-right" style="color: white;" id="bt_fileManageUpload" type="file" name="file" data-url="plugins/kodiasgui/core/ajax/kodiasgui.ajax.php?action=fileupload&path=<?php echo urlencode($kodiasgui->getPath());?>">
<br/><br/><br/>
...
<script>
    ...
    function dipalyFileManageList() {
        $.ajax({// fonction permettant de faire de l'ajax
            ...
            url: "plugins/kodiasgui/core/ajax/kodiasgui.ajax.php", // url du fichier php
            data: {
                action: "list3rdparty",
